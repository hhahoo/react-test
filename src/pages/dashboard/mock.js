  ...
  bigStat: [
    {
      ...
      total: {
        ...
        weekly: 1465,
        daily: 199,
        percent: { value: 12.7, profit: false }
      },
      color: "primary",
      registrations: {
        monthly: { value: 630, profit: false },
        weekly: { value: 105, profit: true },
        daily: { value: 33, profit: true }
      },
      bounce: {
        monthly: { value: 1.5, profit: false },
        weekly: { value: 1.5, profit: true },
        daily: { value: 1.25, profit: true }
      }
    },
    {
      product: "정보성",
    ...
    },
    {
      ...
      bounce: {
        ...
        weekly: { value: 1.35, profit: false },
        daily: { value: 3.1, profit: true }
      }
    }
  ],
  notifications: [
